...
class Article extends \Blog\Entity\Article implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Blog\\Entity\\Article' . "\0" . 'id', '' . "\0" . 'Blog\\Entity\\Article' . "\0" . 'title', '' . "\0" . 'Blog\\Entity\\Article' . "\0" . 'bookImg', '' . "\0" . 'Blog\\Entity\\Article' . "\0" . 'price', '' . "\0" . 'Blog\\Entity\\Article' . "\0" . 'article', '' . "\0" . 'Blog\\Entity\\Article' . "\0" . 'shortArticle', '' . "\0" . 'Blog\\Entity\\Article' . "\0" . 'isPublic', '' . "\0" . 'Blog\\Entity\\Article' . "\0" . 'category', '' . "\0" . 'Blog\\Entity\\Article' . "\0" . 'comments');
        }
    ...
    public function setBookImg($bookImg)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBookImg', array($bookImg));

        return parent::setBookImg($bookImg);
    }
    ...
    public function getBookImg()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBookImg', array());

        return parent::getBookImg();
    }
